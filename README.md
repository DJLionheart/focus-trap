...
- **preventScroll** {boolean}: Default: `false`. If `true`, the screen will not scroll a focused element into view. Although this option defaults to `false`, the scroll behavior is most evident in Internet Explorer.
